...
import logo from './van guardian logo.png'; // Importing logo
...
<Col md={3}>
  <Card bg="light" className="rounded p-3 mb-3" style={{ width: '350px' }}>
    ...
    <div style={{ overflowX: 'auto' }}> {/* Add this div with overflow style */}
 ...
 <Col md={3} className="d-flex flex-column align-items-end">
    {/* Column for Logo, Student Count, and Driver Count */}
