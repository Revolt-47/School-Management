...
const {VerifyRegistrationToken,VerifySchoolorAdmin} = require('../utils/Authenticate')
...
router.post('/pause-subscription',VerifyRegistrationToken,VerifySchoolorAdmin,paymentController.pauseSubscription);
router.post('/resume-subscription',VerifyRegistrationToken,VerifySchoolorAdmin,paymentController.resumeSubscription);
